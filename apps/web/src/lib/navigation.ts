...
export const navigationItems: NavigationItem[] = [
  { href: "/", label: "年度財務總覽", description: "年度收支、預算與現金流", group: "瀏覽", color: "#0d9488" },
  { href: "/cash-flow", label: "現金流", description: "收入、支出與淨流量", group: "瀏覽", color: "#0284c7" },
  { href: "/bills", label: "信用卡帳單檢視", description: "實際帳單與預估帳單", group: "瀏覽", color: "#7c3aed" },
  ...
  { href: "/spending-analysis", label: "消費分析", description: "月季趨勢與預算建議", group: "記帳", color: "#0891b2" },
  { href: "/review", label: "待確認發票明細", description: "匯入與規則審核", group: "記帳", color: "#ea580c" },
  { href: "/budget", label: "預算管理", description: "年度與月度預算", group: "管理", color: "#4f46e5" },
  { href: "/settings", label: "系統設定", description: "信用卡、商戶與分類規則", group: "管理", color: "#94a3b8" },
];
